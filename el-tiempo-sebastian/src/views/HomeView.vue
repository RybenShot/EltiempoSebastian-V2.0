<template>
  <div class="home" id="BGGeneral">
    ...
    <div class="mx-6 ">
      ...
      <div class="columns">
        <div class="card column mx-3 BGGlass">
          <h3 class="title has-text-light is-3 ">Sensacion termica</h3>
          <p class="has-text-light">{{ this.fellsLike }}ºC</p>
        </div>
        <div class="card column mx-3 BGGlass">
          <h3 class="title has-text-light is-3">Temp max</h3>
          <p class="has-text-light">{{ this.tempMax }}</p>
        </div>
        <div class="card column mx-3 BGGlass">
          <h3 class="title has-text-light is-3">Temp min</h3>
          <p class="has-text-light">{{ this.tempMin }}</p>
        </div>
      </div>
      <br>
    </div>
